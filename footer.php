                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 ">
                                        ...
                                        <li class="footer-menu-item"><a href="about-us.php">about</a></li>
                                        <li class="footer-menu-item"><a href="services.php">Services </a></li>
                                        <li class="footer-menu-item"><a href="portfolio.php">Portfolio</a></li>
                                        <li class="footer-menu-item"><a href="growth-fund.php">Growth Fund</a></li>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 ">
                                        ...
                                        <li class="footer-menu-item"><a href="contact-us.php">Contact</a></li>
                                        <li class="footer-menu-item"><a href="faq.php">FAQ</a></li>
                                        <li class="footer-menu-item"><a href="https://investors.growth-sense.com/">Investor</a></li>
                                        <li class="footer-menu-item"><a href="cyber-security-warning.php">Cyber security warning</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-heading d-flex align-items-center justify-content-between">
                                        <span>Associate Companies</span>
                                    </h4>
                                    <ul class="footer-menu list-unstyled mb-0 foot-comp">
                                        <li class="footer-menu-item">
                                            <img src="./assets/img/foot-comp1.jpg" alt="">
                                            <p>To help you with your Technology</p>
                                            <a href="https://growthmetaverse.in/" target="_blank">Growth Metaverse Pvt Ltd</a>
                                        </li>
                                        <li class="footer-menu-item">
                                            <img src="./assets/img/foot-comp2.png" alt="">
                                            <p>To help you with your brand and media presence</p>
                                            <a href="https://growthcirclecreatives.com/" target="_blank">Growth Circle Creatives Pvt Ltd</a>
                                        </li>
                                        <li class="footer-menu-item">
                                            <img src="./assets/img/foot-comp3.jpg" alt="">
                                            <p>Our Startup Marketplace</p>
                                            <a href="https://growth91.com/" target="_blank">Growth91 Advisors Private Limited</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-12 footer-widget">
                                <div class="footer-widget-inner d-flex justify-content-end align-items-center">
                                    <h4 class="footer-heading d-flex align-items-center justify-content-between">
                                        <span>Follow Us</span>
                                    ...
                                    <div class="footer-social-wrapper">
                                        <ul class="footer-social list-unstyled d-flex align-items-center flex-wrap mb-0">
                                            ...
                                            <li class="footer-social-item">
                                                <a href="https://www.facebook.com/VibrantGrowthSense">
                                                    <i class="fa fa-facebook-square" aria-hidden="true"></i>
                                                </a>
                                            </li>

                                            <li class="footer-social-item">
                                                <a href="https://www.linkedin.com/company/growth-sense/">
            ...
            <div class="footer-bottom bg-5">
                <div class="container">
                    <div class="footer-bottom-inner d-flex flex-wrap justify-content-md-between justify-content-center align-items-center">
                        ...
                        <p class="copyright footer-text">©<span class="current-year"></span> Growth Sense Pvt Ltd. All
                            Rights Reserved. Developed by <a href="index.php">ZROW SOLUTIONS</a> </p>
                    </div>
                </div>
            </div>
        </footer>
                ...
                <div class="offcanvas-body p-0 d-flex flex-column justify-content-between">
                    <nav class="site-navigation">
                        <ul class="main-menu list-unstyled">
                            ...
                            <li class="menu-list-item nav-item">
                                <a class="nav-link" href="https://investors.growth-sense.com/">Investor</a>
                            </li>
                            <li class="menu-list-item nav-item">
                                <a class="nav-link" href="cyber-security-warning.php">Cyber Security Warning</a>
                            </li>
        ...
        <div class="joinchat__button">
            <a href="https://api.whatsapp.com/send?phone=917588544442&text=Welcome%20to%20Growth%20Sense">
            ...
            <div class="offcanvas-body p-0">
                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="assets/img/products/furniture/1.jpg" alt="" />
                            </div>
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="assets/img/products/furniture/2.jpg" alt="" />
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="assets/img/products/furniture/3.jpg" alt="" />
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="assets/img/products/furniture/4.jpg" alt="" />
                            </div>
                            <div class="product-info">
                                <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                <p class="product-vendor">XS / Dove Gray</p>
                ...
                <div class="cart-empty-area text-center py-5 d-none">
                    <div class="cart-empty-icon pb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-frown">
                            ...
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="product-gallery product-gallery-vertical d-flex">
                                    <div class="product-img-large">
                                        <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                            ...
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/39.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/38.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/37.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/36.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/34.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/30.jpg" alt="">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="assets/img/products/bags/32.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-img-thumb">
                                        ...
                                        <div class="activate-arrows show-arrows-always arrows-white d-none d-lg-flex justify-content-between mt-3">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                var last_string = pieces[pieces.length - 1];
                if (last_string == "") {
                    // alert(last_string);
                    ...
                    // alert(last_string)
                    var get_current_url = $('.main-menu li  a[href="' + last_string + '"]');
                    var parent_path = get_current_url.parent();
                    parent_path.addClass("active");
                }
        ...
        <!-- The Modal -->
        <div class="modal welcome-modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">

                    <div class="modal-header">
                        <h4 class="modal-title">Cyber Security Warning</h4>
                    ...
                    <div class="notes-modal">
                        <div class="notes-content">
                            ...
                            <p>
                                Growth Sense Private Limited or any of it’s associate companies DO NOT ask for money for giving Jobs or employment to anyone. We have noticed that, as we are growing; some cyber criminals are using our company name to collect money for offering job or some kind of work from home opportunities. We request everyone not to fall in this cyber criminal’s trap. Growth Sense Private Limited or any of it’s associate companies, shall not be responsible for any financial or other loss or damages to anyone.
                            ...
                            <p>
                                ग्रोथ सेंस प्राइवेट लिमिटेड या इसकी कोई भी सहयोगी कंपनी किसी को नौकरी या रोजगार देने के लिए पैसे नहीं मांगती है। हमने देखा है कि, जैसे-जैसे हम बढ़ रहे हैं; कुछ साइबर अपराधी नौकरी या घर से किसी प्रकार के काम की पेशकश के लिए धन इकट्ठा करने के लिए हमारी कंपनी के नाम का उपयोग कर रहे हैं। हम सभी से अनुरोध करते हैं कि इस साइबर अपराधी के जाल में न फंसें। ग्रोथ सेंस प्राइवेट लिमिटेड या इसकी कोई भी सहयोगी कंपनी किसी भी वित्तीय या अन्य हानि या क्षति के लिए जिम्मेदार नहीं होगी।
                            </p>
                        </div>
