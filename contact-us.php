        ...
        <div class="contact-box mt-100">
            <div class="contact-box-wrapper">
                                ...
                                <div class="col-lg-12 col-12 col-sm-12 col-md-12 col-xl-12">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-details">
                                            <h2 class="contact-title">Email Us at</h2>
                                            <a class="contact-info" href="mailto:contact@www.growth-sense.com">contact@www.growth-sense.com</a>
                                            <a class="contact-info" href="mailto:info2@example.com">contact@growthsense.co.in</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12 col-sm-12 col-md-12 col-xl-12">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-details">
                                            ...
                                            <p class="contact-info">Akola</p>
                                            <p class="contact-info">Ahmedabad</p>
                                            <p class="contact-info">Mumbai</p>
                                ...
                                <div class="col-lg-12 col-12 col-sm-12 col-md-12 col-xl-12">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-details">
                                            ...
                                            <strong class="mt-2">Funding and Investor Relations</strong>
                                            <a class="contact-info" href="tel:7588544442">7588544442</a>
                                            <strong>Startup Support Services</strong>
                                            <a class="contact-info" href="tel:7588544441">7588544441</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container mt-5 mb-5">
                    <div class="row">
                        <div class="col-lg-12">
                            <img src="https://www.growth-sense.com/wp-content/uploads/2021/05/WhatsApp-Image-2021-05-02-at-11.57.39-AM.jpeg" alt="" srcset="">
                        </div>
                    </div>
                </div>
            </div>
